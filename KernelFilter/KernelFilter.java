 ...
 *  Execution:    java KernelFilter imagename variant
 *  Dependencies: Picture.java
 *
 *  Opens a picture file and displays it with a specific filter applied
 *  Variants that are availible are gaussian, sharpen, laplacian, emboss, and motionBlur
 *
 *  % java KernelFilter baboon.png laplacian
 *
 *  Remarks
 *  -------
 *   - pixel (i, j) is column i and row j, where (0, 0) is upper left
 *
 *  By Jason Chan Pd.8 and Arib Chowdhury Pd.3
 * 
 ******************************************************************************/
